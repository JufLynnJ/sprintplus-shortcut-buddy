...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SprintPlus & Sprint Online oefenen" },
      { name: "description", content: "Speelse oefeningen voor SprintPlus-sneltoetsen en de Sprint Online-werkbalk." },
      { name: "author", content: "SprintPlus Trainer" },
      { property: "og:title", content: "SprintPlus & Sprint Online oefenen" },
      { property: "og:description", content: "Speelse oefeningen voor SprintPlus-sneltoetsen en de Sprint Online-werkbalk." },
